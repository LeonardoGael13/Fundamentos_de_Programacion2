...
import sys #Para interactuar directamente con el intérprete del sistema, proporcionando acceso a variables y funciones.
import platform #Se utiliza para acceder de forma portable a información subyacente sobre el sistema operativo.
import subprocess #Crear y gestionar nuevos procesos externos (subprocesos) directamente desde el código Python.
from PyQt5.QtCore import Qt #Sirve para crear aplicaciones multiplataforma con interfaces gráficas de usuario 
from PyQt5.QtWidgets import (
    QApplication, #Sirve para gestionar el ciclo de vida de una aplicación gráfica de usuario
    QWidget, #
    QLabel,  #
    QLineEdit, #
    QPushButton, #
